...
use Dpb\Package\TaskMS\Application\UseCase\Inspections\UpdateInspectionTempalteUseCase;
...
class EditInspectionTemplate extends EditRecord
{
    ...
    {
        return __('tms-ui::inspections/inspection-template.form.update_heading', ['title' => $this->record->title]);
    }
    ...
    protected function handleRecordUpdate(Model $record, array $data): Model
    {
        ...
        $inspectionTemplate = app(UpdateInspectionTempalteUseCase::class)->execute($record->id, $data);
        return $record;
    }  
}
