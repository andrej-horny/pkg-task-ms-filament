    ...
    public static function make(Table $table): Table
    {
        return $table
            ...
            ->recordClasses(fn($record) => match ($record->ticketItem->state?->getValue()) {
                States\TS\TaskItem\Created::$name => 'bg-blue-200',
                States\TS\TaskItem\Closed::$name => 'bg-green-200',
                States\TS\TaskItem\Cancelled::$name => 'bg-gray-50',
                States\TS\TaskItem\InProgress::$name => 'bg-yellow-200',
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('ticketItem.code')
                    ->label(__('tasks/task-item.table.columns.code.label'))
                    ->grow(false),
                Tables\Columns\TextColumn::make('ticketItem.date')->date()
                    ->label(__('tasks/task-item.table.columns.date.label'))
                    ->grow(false),
                ...
                Tables\Columns\TextColumn::make('subject')
                    ...
                    ->state(function (TaskItemAssignment $record, TaskAssignmentService $svc) {
                ...
                Tables\Columns\TextColumn::make('assignedTo.code')
                    ...
                    // ->state(function (TaskItemAssignment $record, TaskItemAssignment $ticketItemAssignment) {
                ...
                Tables\Columns\TextColumn::make('expenses')
                    ->label(__('tasks/task-item.table.columns.expenses'))                    
                    ->state(function ($record) {
