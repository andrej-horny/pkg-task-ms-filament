...
class WorkAssignmentRepeater
{
    public static function make(string $uri): Component
    {
        return TableRepeater::make($uri)
            ...
            ->headers([
                Header::make('date')
                    ->label(__('tasks/task-item.form.fields.activities.work_log.date')),
                Header::make('time_from')
                    ->label(__('tasks/task-item.form.fields.activities.work_log.time_from')),
                Header::make('time_to')
                    ->label(__('tasks/task-item.form.fields.activities.work_log.time_to')),
                Header::make('contract')
                    ->label(__('tasks/task-item.form.fields.activities.work_log.contract')),
